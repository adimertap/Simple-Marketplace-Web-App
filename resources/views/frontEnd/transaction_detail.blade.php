        ...
        <div class="row">
            ...
            <form action="/transaction/{{$data[0]->transaction_id}}" method="post" enctype="multipart/form-data">
                ...
                @elseif($data[0]->status == 'delivered')
                    ...
                    <div style="text-align: left;">
                        <button type="submit" name="submit" {{-- onclick="myFunction()" --}} id="success" class="btn btn-success">Set Status Success</button>
                    </div>
                @elseif($data[0]->status == 'success')
                    </form>
                    <p style="color: black;">Your Payment has Success</p>
                     <div style="text-align: left;">
                        <button type="submit" name="submit" onclick="myFunction()" id="ulasan" class="btn btn-success">Review Item</button>
                    </div>
                @else
                    <p style="color: black;">Your Payment has Success</p>
                @endif
                        ...
                        <form action="{{url('/apply-coupon')}}" method="post" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls {{$errors->has('coupon_code')?'has-error':''}}">
                                    ...
                                    <span class="text">{{$errors->first('coupon_code')}}</span>
                                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="total_area" >
                        <ul>
                                ...
                                <li style="background: white; color: black;">Total <span>Rp {{number_format($data->shipping_cost+$total_price)}}</span></li>
                        </ul>
