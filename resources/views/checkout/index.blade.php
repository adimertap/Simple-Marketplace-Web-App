        ...
        <div class="row">
            ...
            <form action="/check-shipping" method="get" class="form-horizontal">
                    ...
                    <div class="login-form"><!--login form-->
                        ...
                        <legend style="color: black;">CHECK OUT BARANG</legend>
                        ...
                        <button type="submit" name="submit" class="btn btn-info">Cek Ongkir</button>
                        </div>
                    </div><!--/login form-->
            ...
            <div class="col-sm-4">
                <form action="/order-review" method="get" class="form-horizontal">
                    <div class="signup-form"><!--login form-->
                        ...
                        <div style="text-align: center;">
                            <button type="submit" name="submit" class="btn btn-info">Review Order</button>
                        </div>
